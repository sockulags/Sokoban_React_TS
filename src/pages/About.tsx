...
export const About = () => {
    return (
        <div className='about-container'>
            ...
            <p>Sokoban is a classic puzzle game that originated in Japan in the early 1980s. Its name translates to "warehouse keeper" in Japanese. The game features simple yet challenging gameplay that has captivated players for decades.</p>
            <h2>Gameplay</h2>
            <p>In Sokoban, players control a character who must push boxes or crates to designated locations within a warehouse or maze. The goal is to strategically move the boxes to their target positions, utilizing logic and planning to avoid getting stuck or trapping boxes in inaccessible locations.</p>
            <p>The game typically features grid-based levels where the player navigates through corridors and obstacles, pushing boxes around to solve each puzzle. As players progress through the levels, the puzzles become increasingly complex, requiring careful consideration of each move.</p>
            <h2>History</h2>
